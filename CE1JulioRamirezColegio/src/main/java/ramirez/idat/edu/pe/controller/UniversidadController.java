...
import ramirez.idat.edu.pe.service.UniversidadService;
...
public class UniversidadController {
	...
	public ResponseEntity<Universidad> obtenerPodId(@PathVariable Integer id) {
	...
	public ResponseEntity<Void> editar(@RequestBody Universidad universidad) {
		Universidad u = service.obtener(universidad.getIdUniversidad());
